	...
	- Module 5 - Seeking Solutions
	  collapsed:: true
		...
		- What is the Lean Canvas
			- ![image.png](../assets/image_1675222610973_0.png)
...
- New highlights added [[2023-01-29]] at 12:18 AM
  collapsed:: true
	...
	- Money that’s spent convincing a customer to make a purchase is called the Customer Acquisition Cost. In order to be profitable, at the simplest level, customer acquisition cost will need to be lower than customer lifetime value, since you need to make more money than you spend acquiring the customer. ([View Highlight](https://read.readwise.io/read/01gqxy16xzcjdgv4ptcn3x5nmt))
		...
		- The LTV-to-CAC ratio is one of the most important KPIs in digital business, as it is the length of time to reach CAC breakeven. You need to be making enough money on your customers to justify the cost of acquiring them. ([View Highlight](https://read.readwise.io/read/01gqxy2j02kda362tjf8hdbh07))
...
- New highlights added [[2023-02-08]] at 12:43 AM
  collapsed:: true
	...
	- Agile works great for the Digital PM because it enables the validation cycle. What you get
	  ...
	  going on. You get flexibility in decision-making and you get higher quality because it’s very
	...
	- Definition of Done and Definition of Ready
	  ...
	  • DoD: A product Increment is considered “done”. ([View Highlight](https://read.readwise.io/read/01grqpxckc963x5dqzkt3ygs4f))
	- An increment is “potentially releasable” if it adheres to the teams Definition of DONE. This
	  does not mean it will be released, but that it meets the standards, usually something to the
	  effect of what is built works, has been tested, has been documented, and checked in. Doth
	  definitions are intended to be light-weight written checklists, generally displayed prominently
	  wherever the team can see them, so they are clear and well-understood. Don’t obsess over
	  details – the point is to communicate expectations. ([View Highlight](https://read.readwise.io/read/01grqpxgbnwdjwz2xs04dcgj4x))
	- There can be variations on DOd. For example, ‘Done-Done’ can be used to specify that an
	  increment is to deploy in production, or is already available to customers. Again, simpler is
	  better. ([View Highlight](https://read.readwise.io/read/01grqpxtd4nbx6b6fnn601nyr9))
	- The recommended team size is 7 to 9 people. There’s no harm in going smaller than 7, but
	  once you go above 9 communication can start to break down. And negative team dynamics
	  start to take place. If your team needs to do more, then the team needs to break into
	  additional, smaller teams. The Product Owner and Scrum Master roles are typically not
	  included in this count unless they are also executing the work of the Sprint Backlog. ([View Highlight](https://read.readwise.io/read/01grqq0dgvcaam5rz7bjxrkc25))
	- The Product Owner (PO) is responsible for managing the Product and Sprint Backlogs.
	  The PO helps facilitate Sprint Planning, Release Planning and also attends the team’s daily
	  standups. The PO writes and helps elaborate user stories & acceptance criteria, co-leads Sprint ([View Highlight](https://read.readwise.io/read/01grqq0j1cfdye0rjwff4a5y3w))
	- Reviews and participates in the Sprint Retrospective. The PO must also ensure that any stories
	  they put into the backlog meet the Definition of Ready so the team will accept them and
	  begin working on them. They also accept stories and iterations as complete, pursuant to the
	  teams Definition of Done. They are available to the team to clarify the product needs as
	  embodied in the User Stories, so the team doesn’t have to guess.
	  The Scrum Master (SM) is responsible for facilitating the work of the sprint team and
	  serving as a coach to team members. It is not uncommon for the SM to also be developer or
	...
	- Sometimes, the team can’t estimate how hard a technical challenge will be to solve , or how
	  ...
	  can break down a complex problem into smaller pieces which can be solved in one sprint. This
	  is very helpful for reducing technical risk. ([View Highlight](https://read.readwise.io/read/01grqr7ysxsc533vp06r02ytaz))
	- Intro to Usability Testing
	  There are three benefits to Usability Testing:
	  1. Uncover problems in the design
	  2. Discover opportunities to improve the design
	  3. Learn about users’ behavior and preferences ([View Highlight](https://read.readwise.io/read/01grqr82ansgz0e479dmen7s78))
	- In a usability-testing session, a researcher (called a “facilitator” or a “moderator”) asks a
	  ...
	  for feedback. ([View Highlight](https://read.readwise.io/read/01grqr8m0x32fqs8j8nq6szrfn))
	- Years of research and statistical analysis have helped us determine that 5 tests are generally
	  sufficient to identify all the issues you are likely to find while testing. Testing just 5 users
	  would turn up 85% of the problems in an interface. This conclusion is brought to you by
	  binomial probability, better known as the Poisson Distribution—which can show us the
...
- New highlights added [[2023-02-12]] at 1:01 PM
  collapsed:: true
	...
	- There are three parts to a User Story: WHO they are, WHAT are they trying to do, and
	  WHY they want to achieve that goal. T ([View Highlight](https://read.readwise.io/read/01grqryteazs2yvnn6spt4bm0j))
	- Here are some guidelines for writing high quality User Stories:
	  1. Stories can often be written directly from storymap tasks
	  2. Stories should never include solution elements
	  3. Stories should always include Acceptance Criteria. Acceptance Criteria is how you know
	  when a story is complete; it is very helpful for QA to be able to test the story was
	  implemented correctly and completely.
	  4. Stories are supposed to fit into a sprint - at most. It should be about 0.5 days to 2 weeks of
	  work. Certainly, no longer than an iteration. (otherwise it is an epic) ([View Highlight](https://read.readwise.io/read/01grqrz6dxg51htzw6tdpmc2ej))
	- Release Planning and Roadmaps ([View Highlight](https://read.readwise.io/read/01grqrzsewv5gpdgr4ps0h5pwn))
	- A Product Roadmap is the expression of your company’s strategy as a product vision. It is
	  about your products (including whole products – i.e. services). But it’s NOT a project plan, a
	  Gantt chart, or a promise of specific functionality on specific dates. ([View Highlight](https://read.readwise.io/read/01grqs08py2gbat5jmgmd2c94f))
	- That said, roadmap and backlog are on the same continuum and are closely connected: The
	  former is all about business outcomes – intention and aspiration. The latter is all about details
	  of execution.
	  They are connected together by the release plan, which is the way the roadmap gets
	  expressed in the world. Note that the Roadmap does NOT have to reflect the release plan
	  exactly. In fact, in companies practicing really frequent or continuous delivery of small
	  iterations, it really doesn’t. ([View Highlight](https://read.readwise.io/read/01grqs6png10pgz8603cnb2mmn))
	- Agile Teams Still Need a Roadmap! Your roadmap highlights your key focus areas. Is a
	  critical communication tool to enroll & align customers and other stakeholders. It’s an
	  invitation to discuss strategy - not the detailed plan. It also helps you communicates
	  uncertainty. ([View Highlight](https://read.readwise.io/read/01grqs6dzvwxzm67gc2dag0rn7))
	- uncertainty.
	  Roadmaps can be created in many formats. We will feature the Now/Next/Later format. ([View Highlight](https://read.readwise.io/read/01grqs6stn8n7zpfgz15fa18x5))
	- Here is the typical layout for a N/N/L roadmap. Remember these key points:
	  • It’s a high-level abstraction and invitation to a discussion. Notice the deliberate
	  abstraction of Near-Term Commitment, to Mid-Term Intention, to Long-Term
	  Aspiration.
	  • It should focus on User/Customer Value!
	  • It‘s NOT a detailed engineering plan– and doesn’t show ‘how long you’re working on any
	  item’
	  • It’s NOT a contract for Sales to commit you to. Don’t make promises you can’t keep!
	  • It’s always better under-promise and over-deliver
	  • Even if marked ‘Confidential’, always assume competitors will see it; this is another reason
	  to stay high-level ([View Highlight](https://read.readwise.io/read/01grqs7gsxa6bht4a9zpfhkv7y))
	- Here is another example of the N/N/L roadmap. Notice again the deliberate abstraction of
	  Near-Term Commitment, to Mid-Term Intention, to Long-Term Aspiration, with less detail
	  as you move forward in time.
	  Keep focused on the Personas and Problems you plan to tackle – not your features!
...
- New highlights added [[2023-02-13]] at 11:13 PM
  collapsed:: true
	...
	- Product-led Growth: Five Rules
	  ...
	  2. Give before you get – deliver value immediately, and definitely before you ask for payment
	  3. Obsess about Growth- drive monetization, retention & referral through every interaction your users have with your product
	  4. Make it Easy and Fun – assure simple, productive user Onboarding & Activation, gamify where you can
	  5. Organize around Product & User – Use PLG to inform how PM interacts with Marketing & Sales. ([View Highlight](https://read.readwise.io/read/01gs71krddgsdnt8mdjqfx52ws))
	- Product-led Rule 1: Know Thy User As we’ve noted, knowing your User is essential to delighting them. Hiring a UX expert and practicing Design Thinking are good starts. Customer Journey Mapping is also a very powerful technique to better know your user. We’ve encountered four major types of journey maps. While they look similar on the surface, each has a different focus and business purpose: ([View Highlight](https://read.readwise.io/read/01gs71myaa489z9cvsqhev3h1b))
	- Current state: The most common type of journey map, these maps illustrate what your customers do, think, and feel as they interact with your business today. Because these maps highlight existing pain points of your customers, they’re well suited for driving incremental improvements to your customer experience (CX) ([View Highlight](https://read.readwise.io/read/01gs71n6rch9c9f9cghxz40516))
...
- New highlights added [[2023-02-28]] at 11:36 PM
  collapsed:: true
	...
	- When interviewing potential users/customers, these (above) are the key areas to probe for
	  their potential Gains. Ask questions, like:
	  • Which savings would make you happy? (e.g. in terms of time, money and effort, …)
	  • What outcomes does you expect and what would go beyond your expectations? (e.g.
	  quality level, more of something, less of something, …)
	  • How do current solutions delight you? (e.g. specific features, performance, quality, …)
	  • What would make your job or life easier? (e.g. flatter learning curve, more services, lower
	  cost of ownership, …)
...
- New highlights added [[2023-03-12]] at 8:32 PM
  collapsed:: true
	...
	- For decades,
	  ...
	  call the buyer’s journey, or the way a prospective buyer of a product becomes aware of the
	  product and its utility, to their ultimate purchase of the product. ([View Highlight](https://read.readwise.io/read/01gvbwr19yyebdew4kmkefrn7z))
	- This funnel concept has most commonly been applied to B2B products, but it applies broadly
	  to any product in any type of market. Consumer buyers go through each of these stages, even
	  for minor purchases - though they may be so expedited that the consumer barely notices. ([View Highlight](https://read.readwise.io/read/01gvbwrhmnfdmwkyj4h4m79hyy))
	- The funnel concept has long been marketing and sales’ way of describing how they could take
	  the broad addressable market and work through these stages to turn a potential into a buyer.
	  The reason this is a “funnel” is because, for every given number of people in your addressable
	  market, only some percentage would be paying attention, and a smaller number still would
	  get seriously interested in your product. And so on. Your Marketing team works to get
	  attention at the ‘top of the funnel’ [or ‘ToFu’], and hands-off any leads to Sales that show
	  significant signs of interest in your product – for instance downloading a whitepaper or asking
	  for a demo. We call these Marketing-Qualified Leads (MQL). Sales then comes on the scene
	  to work with customers on budget and timeline, and to hopefully get them to purchase. Once
	  a prospect has been further developed by Sales, and more likely to close, it becomes
	  known as a Sales-Qualified Lead (SQL). ([View Highlight](https://read.readwise.io/read/01gvbx06hnf7vcrt1kevqadesx))
	-  With the exception of possible trials or Proof of Concept efforts, most users never
	  experienced the product at all, until it was purchased for them. ([View Highlight](https://read.readwise.io/read/01gvbx0f2n3zdhw1thgnfxqn68))
	- Many companies still operate along these lines today, and these concepts are neither wrong
	  nor outmoded. But, they are just one of the ways to grow your business.
	  Today, many types of companies are discovering a new way to grow which is product-led, and
	  combining or even replacing their prior funnels with different tactics. ([View Highlight](https://read.readwise.io/read/01gvbx0b9epne5vhrgn1yrk9yf))
	- Product-led Rule 2: Give before you get ([View Highlight](https://read.readwise.io/read/01gvbx3jcdfw40g3d7728pqnbd))
	- Rule 2 is all about Acquiring and Retaining Users before selling to Buyers – they might even be
	  the same person
	  Product before Paywall - Explore Freemium and Free Trial
	  Package with care - Save some value for Buyers. Create packages with validated Value
	  Metrics and Fences ([View Highlight](https://read.readwise.io/read/01gvbx3pkcekwt5950evrghwdb))
	- s ([View Highlight](https://read.readwise.io/read/01gvbx3w3z9p979cxz2s3sn1rt))
	- Focus Sales on active users - Make Users happy, sell to their Boss. If you’re a Startup – wait to
	  hire Sales. ([View Highlight](https://read.readwise.io/read/01gvbx3xn7z5a6xbqfpjyc77nm))
	- PLG Rule 3: Obsess about growth – Intro to Pirate Metrics ([View Highlight](https://read.readwise.io/read/01gvbx4kw5hgv9st6y4v88xn4e))
	- One of the most notable aspects of SaaS is its iterative business model. Think of this as a
	  flywheel that should keep running at the same rate, or speed up – never slow down. This
	  three-step process is how digital business economics works – particularly in SaaS businesses.
	  They earn revenue based on how well they do in each of these three areas. This doesn’t equate
	  directly to profit but is necessary for these businesses to succeed and grow. Many important
	  SaaS businesses succeeded by running this flywheel exceedingly well. Most SaaS metrics are
	  based on this model, so this is the foundation for how digital businesses define and track
	  success ([View Highlight](https://read.readwise.io/read/01gvbx7nnnqt4ybk8aptt7y4gn))
	- This framework is all about growing your business – we can use it to measure a new product,
	  or any product that we want to grow. The tricky thing about Pirate Metrics – or really any
	  measurement – is that what you measure really needs to match your product and business
	  model. Let’s look at each of these in order: ([View Highlight](https://read.readwise.io/read/01gvbx95dwzwd0qs4nf0g7kjnc))
	- Acquisition - “Where Are Our Users / Customers Coming From?” Eg Website visit > email
	  signup > webinar participation > sales call > conversion to customer. Lots conversions need to
	  happen driven by marketing & sales ([View Highlight](https://read.readwise.io/read/01gvbx97hgfyrc454zpj284vnh))
	- Activation - “How good is the user’s / customer’s first experience?” All about Successful
	  Implementation + Onboarding and initial task (Aha moment) success! More on onboarding
	  later ([View Highlight](https://read.readwise.io/read/01gvbx9a2xjn9h4k2v0xxac6h6))
	- Retention - “How many of your customers are you retaining and why are you losing the
	  others?” Are they coming back after the initial login? How frequently? Why or why not?
	  Remember: If your Customer Acquisition Rate > Your Customer Churn Rate = Growth! And if
	  your Churn Rate > Acquisition Rate you will likely lose a lot of money ([View Highlight](https://read.readwise.io/read/01gvbx9cjn4xxcqbkfg05vrj3m))
	- Revenue - “How can you increase revenue and further monetize the customers we have?”
	  Upgrades? Cross-Sell? Up-Sell Services? More later on this topic
	  Referral - “How can you turn your customers into your advocates?” ([View Highlight](https://read.readwise.io/read/01gvbx9g6xxcf6nxrqy5pbt5g1))
	- For B2C Products: Activation usually occurs before purchase, and Self-service is the norm.
	  For B2B Products: Purchase or contract likely occurs before Activation. Activation is often
	  owned by your Implementation/Services team
	  Consider the signs of an Activated Facebook User - if a user adds at least 10 friends within the
...
- New highlights added [[2023-03-15]] at 10:22 PM
  collapsed:: true
	...
	- Once you find the folks who are trusted advisers to your customers and prospects, you need to help them do four things. In order, they need to know, use, love and recommend your products or services.
	  Know: They can’t recommend your solution if they don’t know about it. Use: To build their confidence, they have to actually use and understand your product.
	  ...
	  Recommend: Find ways to help influencers amplify this love. Make it easy and rewarding for them to recommend your product. You can use things like referral fees to align your business interests. At Intuit, we built capabilities into our products that made accountant’s lives easier when their clients used QuickBooks, so they were motivated to get more folks using our products. How can you motivate your influencers to get more folks using your product or service? ([View Highlight](https://read.readwise.io/read/01gvhmn2nhkd8vn3mtpq0ykq90))
	- Module 9: Optimizing and Experimenting ([View Highlight](https://read.readwise.io/read/01gvhmtn5h4dgnejjfepaxgyb7))
	- Activation can happen before or after purchase. E.g., for B2B, purchase on contract generally comes before first use, and certainly before recurring use. In either case, there are lots of different opportunities to make it easy and fun for our users and customers ([View Highlight](https://read.readwise.io/read/01gvhmvhh8spdds6wvv4b176n0))
	- Activation: Help users reach “aha” quickly with an Onboarding Checklist:
	  Our job is to remove friction during Onboarding, when user motivation is at a high. We should make a strong 1st impression for everything new. Don’t overwhelm your users at the start; reveal functionality gradually. Engage users in-app for Announcements, providing Help, and soliciting feedback. Finally - Make it fun! ([View Highlight](https://read.readwise.io/read/01gvhmx08thy9387yhrb1n6m9y))
	- Here are some best practices, called out in The Elements of User Onboarding, by Samuel Hulick
	  1. Streamline the 1st-run workflow, deliver a relevant “quick win” ([View Highlight](https://read.readwise.io/read/01gvhmx6pzn3kydk572ecrq84c))
	- 2. Preload content wherever possible – what things should you already know about your customer?
	  3. Explicitly call out key early-use activities via lists or completion meters 4. Celebrate completed tasks with a success state reminder
	  5. Incentivize users to become more accountable for ongoing use. We will cover Gamification next. ([View Highlight](https://read.readwise.io/read/01gvhmxfky49vbwe7h1mm1hc6k))
	- Gamify to Drive Retention and Referral Gamification simply refers to the application of game principles & mechanics into a nongame experience. Effective gamification can result in these outcomes: 1.
	  Increased return visits/use
	  2. Build Confidence / Mastery 3. Encourages exploration of advanced features 4. Builds in switching-costs 5. Drives Retention + Referral ([View Highlight](https://read.readwise.io/read/01gvhn3aphf22hty2qd02vabz9))
	- There are two clear advantages to Gamification: • Provides users an engaging place to practice, and a safe place to fail • Builds friendly competition, engagement & motivation ([View Highlight](https://read.readwise.io/read/01gvhn3ryyx19r29ny0zdbzh82))
	- There are two clear disadvantages to Gamification: • It’s easy to lose sight of business goals • If it has no relevance to the user’s job, you won't change behavior User response varies substantially so apply gamification thoughtfully, sparingly, and avoid gimmicks – a little goes a long way. ([View Highlight](https://read.readwise.io/read/01gvhn8jp24gpb3xextrwqqw8m))
	- A/B Testing and a Bit of Statistics
	  A/B Testing is defined simply as a randomized experiment with two variants. It has been used for many years in digital marketing / web design and is routinely used by major SaaS providers to test product changes. The two key things you want to ensure are: 1. Statistical significance: This means the likelihood that the variation you see in your test is NOT due to random chance. Aim for >95% significance. A difference between variants is statistically significant when the chance of at least that big a difference showing up randomly is less than 5% [1]. If our test is changing the color of the “Buy” button, our baseline might be a blue button (A), and our variant a green button (B), The metric we’re tracking is what fraction of users click the button (the conversion rate). If B is significantly better than A at achieving clicks, it means that we can say with 95% certainty that B’s conversion rate for ALL users is higher, no matter the sample size. The larger the difference between variants, the more confident you can be that the results are statistically significant, with fewer samples.
	  2. Random sample: This means there should be no meaningful difference between the groups tested – a lack of bias between groups. Tools and your data team can help here. ([View Highlight](https://read.readwise.io/read/01gvhna6dyvcgrbwyvqnp1kcc2))
